...
import { Bus, ArrowRight, ShieldCheck, UserPlus, LogIn } from "lucide-react";
      ...
      <div className="hidden lg:flex flex-col justify-between w-1/2 bg-gradient-to-br from-primary to-indigo-900 text-white p-12 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="max-w-md">
            <h2 className="text-5xl font-bold font-display leading-tight mb-6">Smart Tracking for Safer Journeys.</h2>
            <p className="text-lg text-primary-foreground/80 leading-relaxed">
              Real-time GPS tracking, attendance monitoring, and automated alerts for schools and parents.
            </p>
          </div>
        </div>
